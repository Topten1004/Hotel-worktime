    ...
    public class WorktimeDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                //optionsBuilder.UseMySql("server=172.16.75.101;user=worktime;database=worktime;port=3306;password=W0rkT1m3:2023;ConvertZeroDateTime=True", ServerVersion.AutoDetect("server=172.16.75.101;user=worktime;database=worktime;port=3306;password=W0rkT1m3:2023;ConvertZeroDateTime=True"));
