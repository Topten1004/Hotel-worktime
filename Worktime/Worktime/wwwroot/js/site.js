...
$(function () {
    ...
    $("#save-address").on("click", function () {
        ...
        $.ajax({
            url: "https://jardideal.worktime.nc/api/worktime/SaveSchedule", // Replace with your save API endpoint
            type: "POST",
    ...
    function loadSetting() {
        $.get('https://jardideal.worktime.nc/api/worktime/geolocation', function (data) {
        ...
        $.ajax({
            url: "https://jardideal.worktime.nc/api/worktime/Setting", // Replace with your actual API endpoint URL
            type: "GET",
            dataType: "json",
